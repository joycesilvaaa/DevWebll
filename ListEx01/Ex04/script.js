...
const categoriaFun = prompt('Digite a categoria do funcionario: (Ex: G (Gerente), F (Funcionario)) ').toLocaleLowerCase()
...
function horaDeTrabalho() {
    const categoria = verificaCategoria(categoriaFun)
...
function mostraResultado() {
    ...
    const salInicial = salarioInicial()
    const auxAliment = auxilioAlimentacao()
