...
class ReservasService {
    ...
    public async createReserva(FormData: ICreateReserva){
        try{
            ...
            const restaurante = await this.restauranteRepository.findOne({
                where: { rest_id: FormData.rest_id }
            })
    ...
    public async readReserva(id: number){
        try{
            ...
            const restaurante : Restaurante = reserva.restaurante

            const reservaDetalhes = {
                res_id: reserva.res_id,
                cliente : cliente.cli_nome,
                restaurante: restaurante.rest_nome,
                localizacao : restaurante.rest_localizacao,
                tipoCozinha: restaurante.rest_tipoCozinha,
